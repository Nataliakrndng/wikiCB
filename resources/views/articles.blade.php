                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="post">
                                ...
                                <h3 class="post-title"><a href="blog-single.html" style="text-decoration: none;">How To Wear Bright Shoes</a></h3>
                                <div class="post-meta">
                                    <ul style="margin-left: -32px;" style="margin-left: -32px;">
                                        <li>
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="blog-single.html" class="btn-main" style="text-decoration: none;">Continue Reading</a>
                                </div>
                            </div>
                            ...
                            <div class="post">
                                ...
                                <h3 class="post-title"><a href="blog-single.html" style="text-decoration: none;">Two Ways To Wear Straight Shoes</a></h3>
                                <div class="post-meta">
                            ...
                            <div class="post">
                                ...
                                <h3 class="post-title"><a href="blog-single.html" style="text-decoration: none;">Making A Denim Statement</a></h3>
                                <div class="post-meta">
                                    <ul style="margin-left: -32px;">
                                        <li>
                                        <i class="ion-calendar"></i> 20, MAR 2020
                            ...
                            <div class="post">
                                <h3 class="post-title"><a href="blog-single.html" style="text-decoration: none;">Standard Text Post</a></h3>
                                <div class="post-meta">
                                    <ul style="margin-left: -32px;">
                                        <li>
                                        <i class="ion-calendar"></i> 20, MAR 2020
                            ...
                            <div class="post">
                                ...
                                <h3 class="post-title"><a href="blog-single.html" style="text-decoration: none;">Standard Audio Post</a></h3>
                                <div class="post-meta">
                                    <ul style="margin-left: -32px;">
                                        <li>
                                        <i class="ion-calendar"></i> 20, MAR 2020
                            ...
                            <div class="post">
                                ...
                                <h3 class="post-title"><a href="blog-single.html" style="text-decoration: none;">Standard Video Post</a></h3>
                                <div class="post-meta">
                                    <ul style="margin-left: -32px;">
                                        <li>
                                        <i class="ion-calendar"></i> 20, MAR 2020
                            ...
                            <div class="pl-0 pl-xl-4">
                                <aside class="sidebar pt-5 pt-lg-0 mt-5 mt-lg-0">
                                    ...
                                    <div class="widget widget-category">
                                        ...
                                        <ul class="widget-category-list" style="margin-left: -32px;">
