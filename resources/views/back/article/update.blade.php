        ...
        <form action="{{ url('article/'.$article->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input type="text" name="title" id="title" placeholder="Title" value="{{ $article->title }}" class="appearance-none block w-full bg-slate-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">
                </div>
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <div> <textarea name="desc" id="editor"> {{ $article->desc }} </textarea></div>
                </div>
                <div class="w-full px-3 mb-6 mt-3 md:mb-0">
                    ...
                    <div class="bg-transparent border border-slate-500 mt-2">
                        <a href="{{ asset('storage/back/'.$article->img) }}" target="_blank" rel="noopener noreferrer">
                            <img src="{{ asset('storage/back/'.$article->img) }}" id="img-preview" class="mt-2" style="max-width: 200px; max-height: 200px;" />
                        </a>
                    </div>
                ...
                <div class="w-full md:w-1/2 mt-3 px-3">
                    ...
                    <div class="relative">
                        <select name="status" id="status" class="appearance-none block w-full bg-slate-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">
                ...
                <div class="w-full md:w-1/2 mt-3 px-3">
                    ...
                    <input type="date" name="publish_date" id="publish_date" placeholder="Publish Date" value="{{ $article->publish_date }}" class="appearance-none block w-full bg-slate-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">
                </div>
